...
NOTE 2! Every time you change the artwork configuration, remember to regenerate the game list. Your changes won't take effect until you do so. Read more about this [here](https://github.com/denisidoro/skyscraper/blob/master/docs/USECASE.md#the-game-list-generation-phase).
